...
export const BIKE_TYPE_OPTIONS: {
...
}[] = [
  {
    value: "xc",
    label: "XC",
    description: "Cross Country — Fast and efficient",
  },
  {
    value: "trail",
    label: "Trail",
    description: "Versatile all-mountain riding",
  },
  {
    value: "enduro",
    label: "Enduro",
    description: "Aggressive downhill and technical",
  },
  {
    value: "downhill",
    label: "Downhill",
    description: "Pure downhill performance",
  },
  {
    value: "gravel",
    label: "Gravel",
    description: "Mixed terrain endurance riding",
  },
];
...
export const RIDING_STYLE_OPTIONS: {
...
}[] = [
  {
    value: "conservative",
    label: "Casual",
    description: "Comfort & control, relaxed trail days",
  },
  {
    value: "moderate",
    label: "Balanced",
    description: "All-round performance & efficiency",
  },
  {
    value: "aggressive",
    label: "Aggressive",
    description: "Max traction, fast cornering",
  },
];
...
export const BIKE_TYPE_TIRE_DEFAULTS: Record<
  BikeType,
